...
function ZegoMemberList(props) {
  ...
  const itemBuilderView = item => itemBuilder ? /*#__PURE__*/_react.default.createElement(_reactDelegateComponent.default, {
    to: itemBuilder,
    props: {
      userInfo: item
    }
  ...
  const renderItem = _ref => {
    ...
    return !itemBuilder ? /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      ...
      style: styles.name
    }, item.userName + (item.userID == _ZegoUIKitInternal.default.getLocalUserInfo().userID ? ' (You)' : ''))), /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      style: styles.itemRight
    }, iconMicView(item), iconCameraView(item))) : itemBuilderView(item);
  };
