...
export default function ZegoMemberList(props) {
  ...
  const itemBuilderView = item => itemBuilder ? /*#__PURE__*/React.createElement(Delegate, {
    to: itemBuilder,
    props: {
      userInfo: item
    }
  ...
  const renderItem = _ref => {
    ...
    return !itemBuilder ? /*#__PURE__*/React.createElement(View, {
      ...
      style: styles.name
    }, item.userName + (item.userID == ZegoUIKitInternal.getLocalUserInfo().userID ? ' (You)' : ''))), /*#__PURE__*/React.createElement(View, {
